<div class="generic" style="text-align: left; margin-bottom: 5px;">
    ...
    <div style="{IF NOT google_calendar_post_temp->google_calendar_add_event}display:none;{/IF} background-color:{backcolor}; padding: 5px; margin-top: 3px; border: 1px solid {tablebordercolor};" id="google_calendar_event_div_id">
