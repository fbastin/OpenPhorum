{IF phorum_mod_google_calendar->calendars_to_show}
    ...
    <table cellspacing="0" class="list" style="margin-bottom:20px">
        <tr>
            <th align="left" colspan="7">
                <div style="float: left;"><img style="cursor: pointer;" onclick="phorum_mod_google_calendar_show_event_listing()" title="{LANG->phorum_mod_google_calendar->ShowEventListing}" src="{URL->HTTP_PATH}/mods/google_calendar/images/calendar_add.png" />
    ...
    <table cellspacing="0" class="list" style="margin-bottom:20px; table-layout: fixed;">
        <tr>
            <th align="left" colspan="7">
                <div style="float: left;"><img style="cursor: pointer;" onclick="phorum_mod_google_calendar_hide_event_listing()" title="{LANG->phorum_mod_google_calendar->HideEventListing}" src="{URL->HTTP_PATH}/mods/google_calendar/images/calendar_delete.png" />
                     {LANG->phorum_mod_google_calendar->EventListing}</div>
                {! --- Show a link to the embedded calendar if enabled --- }
                {IF phorum_mod_google_calendar->show_embedded_calendar}
                <div style="text-align: right; float: right;"><a href="{URL->GOOGLE_CALENDAR}">{LANG->phorum_mod_google_calendar->ViewCalendar}</a></div>
        ...
        <tr>
            ...
            {LOOP phorum_mod_google_calendar->event_listing_header}
                <td class="google_calendar_td_header" {IF ALT_EVENT_TD} style="background-color:{alt_background_color};"{/IF}>
            ...
            {LOOP phorum_mod_google_calendar->event_listings}
                ...
                {IF NOT phorum_mod_google_calendar->curr_row_data->full_day_event}
                    <td valign="top"
                        ...
                        {IF ALT_EVENT_TD}style="background-color: {alt_background_color};"{/IF}
