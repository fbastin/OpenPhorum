<div style="text-align: left; margin-bottom: 5px;">
    ...
    <div style="{IF NOT google_calendar_post_temp->google_calendar_add_event}display:none;{/IF} background-color:{bodybackcolor}; padding: 5px; margin-top: 3px;" id="google_calendar_event_div_id">
...
function google_calendar_check_day_value_by_year(curr_el) {
    ...
    <td class="side-column"><div class="empty-position">{INCLUDE "right_tabs_upper_posting_buttons_row"}{INCLUDE "right_tabs_lower_posting_buttons_row"}</div></td>
</tr>
<tr>
    <td class="side-column"><div class="empty-position">{INCLUDE "left_tabs_upper_posting_buttons_row"}{INCLUDE "left_tabs_lower_posting_buttons_row"}</div></td>
    <td class="right-column" colspan="3" style="text-align: center; border-top: 4px solid {headerbackcolor};">
