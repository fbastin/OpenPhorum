...
<!-- cc_multi_upload.tpl -->
  ...
  <form action="{URL->ACTION}" method="post" enctype="multipart/form-data">
      ...
      <input type="hidden" name="blanks" value="{MULTI_UPLOAD_BLANKS}">
      ...
      <div class="generic">
          ...
          <dd>
            ...
            {ELSE}
              {LOOP NUMBERS}
                <input type="file" name="newfile{NUMBERS->number}" size="50" class="uploadblank" /><br />
              {/LOOP NUMBERS}
...
<!--   <input type="submit" value="{LANG->SaveChanges}" /> -->
  <input type="submit" name="delete_checked" value="{LANG->mod_user_image_gallery->delete_checked}" />
...
<form action="{URL->ACTION}" method="post">
  ...
  <input type="submit" name="upload_multi" value="{LANG->mod_user_image_gallery->return_to_single_upload_screen}" class="nonbutton">
</form>
<br />

<form action="{URL->my_gallery}" method="post">
  {POST_VARS}
  <input type="submit" value="{LANG->mod_user_image_gallery->see_your_gallery}" class="nonbutton">
</form>
<br />
